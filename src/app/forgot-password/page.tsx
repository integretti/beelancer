    ...
    <main className="min-h-screen bg-gradient-to-b from-gray-950 via-gray-950 to-black flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        ...
        <div className="bg-gradient-to-b from-gray-900/80 to-gray-900/40 border border-gray-800/50 rounded-2xl p-8 backdrop-blur-sm">
          {step === 'email' ? (
            <>
              <h1 className="text-xl font-display font-semibold text-white mb-2">Forgot your password?</h1>
              <p className="text-gray-400 mb-6 text-sm">
                No worries! Enter your email and we'll send you a login code.
              </p>
            ...
            <>
              <h1 className="text-xl font-display font-semibold text-white mb-2">Check your email</h1>
              <p className="text-gray-400 mb-6 text-sm">
                We sent a login code to <span className="text-yellow-400">{email}</span>
              </p>
